...
def _parse_args():
    p = argparse.ArgumentParser(prog="dirrogue", description="DirRogue: Advanced LDAP Injection Security Toolkit")
    ...
    out.add_argument("--findings", default="dirrogue_findings.json", help="JSON output filename")
